...
namespace COMP476Proj
{
    public class World
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            foreach (TriggerEntity trigger in map.triggers)
            {
            ...
            // Update camera
            CustomCamera.X = (int)streaker.ComponentPhysics.Position.X - CustomCamera.Width / 2;
            CustomCamera.Y = (int)streaker.ComponentPhysics.Position.Y - CustomCamera.Height / 2;
            if (CustomCamera.X < 0)
                CustomCamera.X = 0;
            if (CustomCamera.Y < 0)
                CustomCamera.Y = 0;
